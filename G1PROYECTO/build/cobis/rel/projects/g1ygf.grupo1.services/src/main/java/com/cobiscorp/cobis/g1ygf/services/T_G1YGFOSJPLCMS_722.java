 ...
 */
package com.cobiscorp.cobis.g1ygf.services;
 ...
 * T_G1YGFOSJPLCMS_722 - ClienteForm 
 *
 */
@Path("/G1YGF/PRYCT/T_G1YGFOSJPLCMS_722")
@Component
@Service({T_G1YGFOSJPLCMS_722.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=G1YGF)(task.submodule=PRYCT)(task.id=T_G1YGFOSJPLCMS_722)(task.version=1.0.0))")
,@Reference(name="VW_CLIENTEOCM_920", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_CLIENTEOCM_920)(view.version=1.0.0))")
...
public class T_G1YGFOSJPLCMS_722 {
